...
TEST(UpdateSystemTest, UpdateGrid) {
    ...
    EXPECT_FALSE(grid.getCell(0, 0));
    EXPECT_FALSE(grid.getCell(0, 1));
    EXPECT_FALSE(grid.getCell(0, 2));
    EXPECT_FALSE(grid.getCell(1, 0));
    EXPECT_FALSE(grid.getCell(1, 3));
    EXPECT_FALSE(grid.getCell(2, 0));
    EXPECT_TRUE(grid.getCell(2, 2));
    EXPECT_FALSE(grid.getCell(3, 1));
}